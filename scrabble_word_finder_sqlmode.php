...
// Scrabble word finder backend with MySQL 8 database wordlist pre-loading,
// grouped, sorted, and paginated results.

header("Content-Type: application/json");

// ---- DB INIT ----
$DB_HOST = "127.0.0.1";   // or your MySQL server
$DB_PORT = "3306";        // default MySQL port
$DB_USER = "scrabble_user";
$DB_PASS = "scrabble_pass";
$DB_NAME = "scrabbleDB";
...
if ($row['c'] == 0) {
    ...
    $stmt = $conn->prepare("INSERT IGNORE INTO words (word,length,score) VALUES (?,?,?)");
